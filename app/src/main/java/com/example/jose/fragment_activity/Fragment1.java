package com.example.jose.fragment_activity;
 ...
 * {@link Fragment1.OnFragmentInteractionListener1} interface
       ...
       // button = (Button) v.findViewById(R.id.button2);
        v.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final android.app.FragmentTransaction tm = getFragmentManager().beginTransaction();
                tm.replace(R.id.fLayoutMain1, Fragment2.newInstance("",""));
...
*/
    ...
    //Metodo que introducira en el FrameLayout del main el Fragment2 como nuevo instancia
